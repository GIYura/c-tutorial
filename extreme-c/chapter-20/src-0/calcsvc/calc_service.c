...
double calc_service_add(struct calc_service_t* svc, double a, double b, bool_t mem)
{
    double result = a + b;
    if (!mem)
    {
...
double calc_service_sub(struct calc_service_t* svc, double a, double b, bool_t mem)
{
    double result = a - b;
    if (!mem)
    {
...
double calc_service_mul(struct calc_service_t* svc, double a, double b, bool_t mem)
{
    double result = a * b;
    if (!mem)
    {
