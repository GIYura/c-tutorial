...
/*
@brief: Get student first name
@in: struct student_t*
@in: char* buffer to store number
@out: none
*/
void StudentGetFirstName(struct student_t* student, char* name);

/*
@brief: Get student last name
@in: struct student_t*
@in: char* buffer to store number
@out: none
*/
void StudentGetLastName(struct student_t* student, char* name);

/*
@brief: Get student year of birth
@in: struct student_t*
@out: year of birth
*/
unsigned int StudentGetBirthYear(struct student_t* student);
